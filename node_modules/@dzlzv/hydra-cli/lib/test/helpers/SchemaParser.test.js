...
describe('SchemaParser', () => {
    ...
    it('should load multiple files', () => {
        const parser = new SchemaParser_1.GraphQLSchemaParser('test/fixtures/schema-folder/');
        chai_1.expect(parser.getObjectDefinations()).length(4, 'Should detect 4 types');
    });
