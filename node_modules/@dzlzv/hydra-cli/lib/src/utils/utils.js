...
exports.getWarthogDependency = exports.parseWarthogCodegenStderr = exports.readModuleFile = exports.resolvePackageVersion = exports.copyTemplateToCWD = exports.getTemplatePath = exports.copyFiles = exports.createFile = exports.createDir = void 0;
 ...
 */
function parseWarthogCodegenStderr(stderr, regexExpr = /src\/modules\/\S*.ts/g) {
    const m = stderr.match(regexExpr);
    if (m !== null) {
        throw Error(`Failed to generate Graphql API due to errors: \n` +
...
function getWarthogDependency() {
    ...
    return warthogPackageJson.hydra;
}
